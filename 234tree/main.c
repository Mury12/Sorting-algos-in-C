...
void test_234_tree()
{
    ...
    init(&t);
    int di=0, d;
    int da[50] = {14, 57, 29, 85, 6, 3, 4, 55, 56, 70, 62, 20, 5, 77, 39, 83, 10, 38, 30, 76, 16, 72, 90, 87, 24, 11, 25, 56, 58, 74, 69, 18, 71, 82, 28, 59, 33, 2, 80, 51, 37, 40, 92, 63, 78, 9, 48, 95, 93, 21};
    printf("\n  Tipo: %s - %d elementos \n", tree_type(&t), t.count);
    while(di<9){
        printf("\n\n--Próximo: %d\n", da[di]);
        // getchar();
